...
class __TwigTemplate_515cd104fb14e308cbaf62ba92c68cab91344e2aebd16616479ce4a1d549b416 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<form class=\"w-49-5\" method=\"post\" action=\"";
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        echo "\">
    <button class=\"btn btn-block btn-outline-danger btn-no-right-radius\">";
        // line 4
...
<button data-dismiss=\"modal\" class=\"w-49-5 btn btn-block btn-primary btn-no-left-radius\">";
        // line 6
...
";
    ...
    {
        return array (  41 => 6,  36 => 4,  32 => 3,  26 => 1,);
    }

    public function getSourceContext()
    {
        return new Twig_Source("<form class=\"w-49-5\" method=\"post\" action=\"{{ path('question_delete', {'id': question.id}) }}\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ question.id) }}\">
    <button class=\"btn btn-block btn-outline-danger btn-no-right-radius\">{{ 'button.delete'|trans }}</button>
</form>
<button data-dismiss=\"modal\" class=\"w-49-5 btn btn-block btn-primary btn-no-left-radius\">{{ 'button.cancel'|trans }}</button>

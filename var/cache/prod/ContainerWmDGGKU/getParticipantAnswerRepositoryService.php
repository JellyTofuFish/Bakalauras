...
// Returns the private 'App\Repository\ParticipantAnswerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ParticipantAnswerRepository.php';

return $this->privates['App\Repository\ParticipantAnswerRepository'] = new \App\Repository\ParticipantAnswerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

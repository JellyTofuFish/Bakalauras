...
// Returns the private 'App\Repository\AttributeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AttributeRepository.php';

return $this->privates['App\Repository\AttributeRepository'] = new \App\Repository\AttributeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

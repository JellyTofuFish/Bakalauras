...
// Returns the private 'App\Repository\ParticipantAnswerAttributeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ParticipantAnswerAttributeRepository.php';

return $this->privates['App\Repository\ParticipantAnswerAttributeRepository'] = new \App\Repository\ParticipantAnswerAttributeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

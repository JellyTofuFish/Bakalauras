...
// Returns the private 'App\Repository\TestParticipationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TestParticipationRepository.php';

return $this->privates['App\Repository\TestParticipationRepository'] = new \App\Repository\TestParticipationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

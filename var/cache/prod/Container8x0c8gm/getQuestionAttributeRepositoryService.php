...
// Returns the private 'App\Repository\QuestionAttributeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\QuestionAttributeRepository.php';

return $this->privates['App\Repository\QuestionAttributeRepository'] = new \App\Repository\QuestionAttributeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
